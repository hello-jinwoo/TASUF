...
data = dict(
    ...
    test=dict(
        ...
        with_track=True))
# optimizer
# lr = 0.005 # GPUs * imgs_per_gpu = 64
# lr = 0.0009375 # GPUs * imgs_per_gpu = 12
# lr = 0.0003125 # GPUs * imgs_per_gpu = 4
# lr = 0.00046875 # GPUs * imgs_per_gpu = 6
lr = 0.000234375 # GPUs * imgs_per_gpu = 3

# optimizer = dict(type='SGD', lr=0.005, momentum=0.9, weight_decay=0.0001) # 8 GPUs, 8 imgs_per_gpu
optimizer = dict(type='SGD', lr=lr, momentum=0.9, weight_decay=0.0001) # 2 GPUs, 2 imgs_per_gpu
